 ...
 * Responsibility: Read MPU6886 data with EMA filtering (same API as Sensor B).
 */

#ifndef SENSOR_A_IMU_READER_H
#define SENSOR_A_IMU_READER_H
...
public:
    ...
    // Valores escalados para transmissao (accel * 1000, gyro * 100)
    // FIX BUG-03: Clamp antes do cast para evitar overflow int16_t.
...
private:
    ...
    // FIX BUG-03: Clamp float para int16_t sem overflow (igual ao Sensor B)
